...
> Ecosystem Rewards Checker & Sybil Verifier
...
<div align="center">
  <img src="screenshots/showcase_preview.png" alt="Omni Airdrop Portal Showcase Preview" width="100%" style="border-radius: 12px; box-shadow: 0 16px 48px rgba(0, 229, 255, 0.15); border: 1px solid rgba(0, 229, 255, 0.25);" />
</div>

<div align="center">
  <br />
  <a href="https://omni-airdrop-39821.web.app" target="_blank">
    <img src="https://img.shields.io/badge/🌐%20Launch%20Live%20Application-omni-airdrop-39821.web.app-00e5ff?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Launch App" />
  </a>
...
The Omni Airdrop Portal is a fair-launch distribution hub that verifies community eligibility across multiple blockchains, protects against Sybil attacks, and facilitates gasless reward voucher redemption.

### 🛠️ Technology Stack
`JavaScript` • `HTML5/CSS3` • `Web3Modal` • `Firestore` • `Firebase Hosting`

---

## 🚀 Key Features

- ✨ **Multichain Wallet Activity Scanner (Ethereum, Solana, Arbitrum, Base)**
- ✨ **Cryptographic Sybil Resistance Scoring & Gitcoin Passport Verification**
- ✨ **Tiered Allocation Tier Calculator based on Community Contributions**
- ✨ **1-Click Gasless Voucher Claim Engine**
- ✨ **Live Leaderboard & Allocation Transparency Dashboard**
...
├── app.js                      # Core reactive application logic
...
git clone https://github.com/X3DevBlake/omni-airdrop.git
cd omni-airdrop
